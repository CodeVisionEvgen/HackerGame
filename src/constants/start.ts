export const StartGreeting = `Welcome to the world of hackers, where every line of code is a weapon and every network is a battlefield.
In this thrilling adventure, you will step into the shoes of a skilled hacker navigating the dark underbelly of cyberspace.
As a tech-savvy infiltrator, you'll navigate the darknet, breach secure servers, and orchestrate complex cybercrimes.
